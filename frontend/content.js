...
// By wrapping the entire script in this check, we ensure that the event listener
// is only added once, even if the content script is injected multiple times.
if (typeof window.handsFreeTypeListenerAdded === 'undefined') {
  window.handsFreeTypeListenerAdded = true;
